...
\pt{平均比热直线式}：令 $c_n= a + bT$，则 $q = \int_{T_1}^{T_2} (a + bT)\ \mathrm{d}T = a(T_2-T_1)+\frac{b}{2}(T_2^2-T_1^2) = \left(a + \frac{b}{2}(T_1+T_2)\right)(T_2-T_1)$，平均比热容为 $c_{n,t_1}^{t_2}=a+\frac{b}{2}(t_1+t_2)$，
