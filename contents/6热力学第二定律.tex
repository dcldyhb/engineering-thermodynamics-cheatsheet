...
\pt{开口系}㶲平衡方程：$E_{\mathrm{x},Q}= E_{\mathrm{x},H_2} - E_{\mathrm{x},H_1}+ \frac{m}{2}\left(c_{\mathrm{f}2}^2 - c_{\mathrm{f}1}^2\right)+ W_s + I= E_{\mathrm{x}2} - E_{\mathrm{x}1} + W_s + I$
