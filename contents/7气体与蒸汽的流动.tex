...
\pt{压力比}：$\frac{p}{p_0}=\left(1+\frac{\kappa -1}{2}\mathrm{Ma}^2\right)^{-\frac{\kappa}{\kappa -1}}$
...
\begin{minipage}
    ...
    \pt{外形选择}：先比较 $p_{\mathrm{cr}}$ 与 $p_b$，再决定收缩喷管或缩放喷管。若 $p_b>p_{\mathrm{cr}}$ ，只需要亚音速加速，使用\pt{收缩喷管}；若 $p_b\le p_{\mathrm{cr}}$ ，需要超音速加速，选择\pt{缩放喷管}。
\end{minipage}
\hfill
\begin{minipage}
    [t]{0.48\linewidth}
